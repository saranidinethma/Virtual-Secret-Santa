...
const createConfetti = () => {
  ...
  confetti.style.backgroundColor = ['#e63946', '#2a9d8f', '#f1faee', '#a8dadc', '#457b9d'][Math.floor(Math.random() * 5)];
      ...
      >
        ...
        >
          ...
          <Typography color="textSecondary">
            Start a Secret Santa group and invite your friends and family
          </Typography>
        </FeatureCard>
        ...
        >
          ...
          <Typography color="textSecondary">
            Create your perfect wishlist to help your Secret Santa
          </Typography>
        </FeatureCard>
        ...
        >
          ...
          <Typography color="textSecondary">
            We'll randomly assign your gift recipient and notify you
          </Typography>
        </FeatureCard>
      </Box>
        {[...Array(10)].map((_, i) => (
